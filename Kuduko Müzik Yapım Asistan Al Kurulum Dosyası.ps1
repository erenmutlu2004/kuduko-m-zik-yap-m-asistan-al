...
$downloadButton.Add_Click({
    try {
        $url = "https://raw.githubusercontent.com/kudukomuzikyapim-Official/KudukoM-zikYap-mAsistanAl/main/Kuduko%20Müzik%20Yapım%20Asistan%20Al.ps1"
...
$runButton.Add_Click({
    try {
        ...
        $statusLabel.Text = "Komut çalıştırılıyor..."
    } catch {
