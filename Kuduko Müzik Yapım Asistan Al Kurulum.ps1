...
$form.Text = "Kuduko Müzik Yapım Asistan Al Kurulum"
$form.Size = New-Object System.Drawing.Size(500, 350)

# Bir Label ekleyelim
$label = New-Object System.Windows.Forms.Label
$label.Text = "Kuduko Müzik Yapım Asistan Al Kurulum"
...
$downloadButton.Add_Click({
    ...
    $destinationPath = "C:\Users\$env:USERNAME\Downloads\Kuduko Müzik Yapım Asistan Al.txt"
...
$runButton.Add_Click({
    ...
    $filePath = "C:\Users\$env:USERNAME\Downloads\Kuduko Müzik Yapım Asistan Al.txt"  # Gerçek script dosyasının adını ve yolunu buraya yazın
